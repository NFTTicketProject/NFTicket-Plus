            ...
            >
              <Box sx={style}>
                <div>
                  ...
                  <WarningArea>
                    {warning && <Alert severity="warning">정보를 모두 입력해주세요.</Alert>}
                  </WarningArea>
                </div>
              </Box>
            </Modal>
